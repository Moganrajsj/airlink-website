...
const testimonials = [
    {
        ...
        person: "Mr. K. Muthukumar",
        role: "Proprietor",
        city: "Erode",
        tag: "Textile Business",
        content: "We export to buyers in the UK and Japan. Every video call matters. Before Airlink, we were constantly dealing with dropped calls and slow file uploads. Since switching, our communication has been flawless. Our production team, accounts, and export teams all run on Airlink now.",
        rating: 5,
        color: "#FBBF24",
        metric: "Zero downtime in 10 months",
    },
    {
        name: "Priya Shankar",
        person: "Priya Shankar",
        role: "Work From Home Professional",
        city: "Salem",
        tag: "Family User",
        content: "My husband works from home, my son streams OTT and online games, and I have my own tutoring classes online. We used to fight over bandwidth every evening! Airlink solved everything — 4 devices connected smoothly, no complaints from anyone. Honestly, worth every rupee.",
        rating: 5,
        color: "#60a5fa",
        metric: "4 devices, zero buffering",
    },
    {
        name: "Sri Sai Clinic",
        person: "Dr. Ramesh Babu",
        role: "Medical Practitioner",
        city: "Coimbatore",
        tag: "Healthcare Office",
        content: "Patient records in the cloud, online consultations, insurance claim submissions — all of it needs reliable internet. One downtime can mean a missed appointment or a delayed claim. Airlink has been rock-solid. Their 24/7 NOC actually called us before we even noticed an issue. That's extraordinary service.",
        rating: 5,
        color: "#34d399",
        metric: "Mission-critical uptime achieved",
    },
    {
        name: "Karthik Gaming Zone",
        person: "Karthik R.",
        role: "Gaming Café Owner",
        city: "Namakkal",
        tag: "Gaming Business",
        content: "Running a gaming café, ping is everything. My customers play BGMI, Valorant and Free Fire competitively. With my old ISP, the kids were complaining every day. After Airlink fiber, average ping dropped to under 10ms. Business has doubled because word spread fast about our connection quality.",
        rating: 5,
        color: "#a78bfa",
        metric: "Sub-10ms ping consistently",
    },
    {
        name: "Vijay Stores",
        person: "Mr. Vijayakumar",
        role: "Retail Business Owner",
        city: "Dharmapuri",
        tag: "Retail Shop",
        content: "Our GST billing, UPI payments, and online ordering all run on one connection. When it goes down, we lose sales. Since switching to Airlink, we haven't lost a single sale due to connectivity. Their team installed the same day we called and the setup was professionally done.",
        rating: 5,
        color: "#fb923c",
        metric: "Same-day installation",
    },
    {
        ...
        city: "Chennai",
        tag: "Software Agency",
        content: "We moved to Airlink's 1 Gbps enterprise leased line last year. Our 200+ developers rely on VPNs and cloud infrastructure daily. The symmetrical upload and download speeds are phenomenal. Highly recommended for growing IT companies.",
        rating: 5,
        color: "#FBBF24",
        metric: "1 Gbps symmetrical speed",
    },
    {
        name: "Lakshmi Vidya Mandir",
        person: "Mrs. Revathi D.",
        role: "Principal",
        city: "Tiruppur",
        tag: "Education",
        content: "Online classes and smart boards required an upgrade from our old broadband. Airlink provided campus-wide coverage with absolute stability. Even during heavy rain, our network stays up. Our teachers couldn't be happier.",
        rating: 5,
        color: "#60a5fa",
        metric: "Campus-wide coverage",
    },
    {
        name: "Senthil Auto Components",
        person: "Senthil Kumar",
        role: "Managing Director",
        city: "Karur",
        tag: "Manufacturing",
        content: "Our CNC machines and ERP software communicate in real-time. Any network latency halts production. Airlink's dedicated fiber line has been the most reliable investment we've made this year. Not a single outage during peak shifts.",
        rating: 5,
        color: "#a78bfa",
        metric: "Zero latency spikes",
    }
];
